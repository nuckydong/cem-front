...
const mixins = {
  ...
  created(){
    rapi.queryResourceSettingTable(this,(data)=>{
    ...
    getFormNecessarySettings(initData){
      return [
        ...
        },
        {
          ...
          label: '上级功能名称',
          decoratorOptions:{
            rules: [{ required: true,message:'上级功能名称不能为空' }]
          },
          display: true,
          exist: this.isShowParentItem,
          disabled: true,
        ...
        },
        {
          ...
          label: '安全认证级别',
          decoratorOptions:{
            initialValue:initData.securityLevel.toString(), rules: [{ required: true, message: '请选择安全认证级别!' }]
          },
          display: true,
          exist: true,
          formItemLayout: formItemLayouts.default
