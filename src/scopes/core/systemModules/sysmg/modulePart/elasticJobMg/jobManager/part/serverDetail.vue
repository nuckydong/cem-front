<template>
    <div id="jobDetail" style="height: 100%">
        <ta-border-layout :layout="{header:'55px'}" :centerCfg="{showBar: true}">
            ...
            <div slot="centerExtraContent">
                ...
                <div style="float: right">
                    <ta-button @click="fnBackToServer">返回服务器维度</ta-button>
                </div>
            </div>
            <ta-table :columns="detailColumns" :dataSource="detailGridData" :pagination=false>
                <template slot="status" slot-scope="text, record">
                    <ta-tag v-if="text == 'OK' && record.instanceCount > 0" color="#00a65a " class='no-cursor'>已启用
                    </ta-tag>
    ...
    export default {
        ...
        methods: {
            ...
            loadData() {
                ...
                api.getServerJobDetail(this, data, (result) => {
            ...
            disabledServerJob(jobName) {
                ...
                api.disabledServerJob(this, data, (result) => {
            ...
            enableServerJob(jobName) {
                ...
                api.enableServerJob(this, data, (result) => {
            ...
            shutdownServerJob(jobName) {
                ...
                api.shutdownServerJob(this, data, (result) => {
            ...
            removeServerJob(jobName) {
                ...
                api.removeServerJob(this, data, (result) => {
