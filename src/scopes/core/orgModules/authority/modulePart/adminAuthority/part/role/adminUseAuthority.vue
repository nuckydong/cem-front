...
export default {
  ...
  methods: {
    ...
    onCellChange (node, data) {
      ...
      $api.updateAdminUsePermissionEffectiveTime(this, dd, () => {
    ...
    fnSaveAuthorityEffectiveTime () {
      ...
      $api.saveBatchAdminUsePermissionEffectiveTime(this, data, dd => {
    ...
    fnSaveAdminUsePermission (type) {
      ...
      $api.saveAdminUsePermission(this, data, dd => {
    ...
    fnLoadDefault () {
      ...
      $api.queryUseSysPermission(this, data, dd => {
    ...
    fnQueryUsePermissionByResourceId (item) {
      ...
      $api.queryUsePermissionByResourceId(this, data, dd => {
