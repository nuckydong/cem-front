<template>
  <div class="fit" style="height: 100%">
...
export default {
  ...
  methods: {
    ...
    fnSaveAdminObjectUsePermission (type) {
      ...
      $api.saveAdminGrantPermission(this, data, dd => {
    ...
    fnLoadDefault () {
      ...
      $api.queryGrantSysPermission(this, data, dd => {
    ...
    fnQueryGrantPermissionByResourceId (item) {
      ...
      this.leftDefaultKeys = []
      this.rightDefaultKeys = []
      $api.queryGrantPermissionByResourceId(this, data, dd => {
