...
const mixins = {
  ...
  created(){
    $api.queryOrgSettingTable(this,(data)=>{
    ...
    getFormNecessarySettings(initData){
      return [
        ...
        },
        {
          ...
          display: initData.porgId == '0' ? false : true,
          exist: true,
          disabled: true,
          formItemLayout: formItemLayouts.default
        },
        ...
        },
        {
          ...
          label: '组织机构名称',
          decoratorOptions:{
            rules: [{ required: true, message: '组织机构名称不能为空!' },{ max: 300, message: '组织机构名称超过限制长度!' }], initialValue: initData.orgName
          },
          display: true,
          exist: true,
          formItemLayout: formItemLayouts.default
